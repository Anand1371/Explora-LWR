...
import getCartItems from '@salesforce/apex/B2B_CartController.getCartItems';
...
import deleteCart from '@salesforce/apex/B2B_CartController.deleteCart';
...
export default class B2b_CartContents extends NavigationMixin(LightningElement) {
    /**
